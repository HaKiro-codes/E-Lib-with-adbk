...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2025 at 04:58 PM
...
(412, 'Naruto', 'Masashi Kishimoto', 'Naruto.jpg', 'available', 'Graphic Novels & Comics', 'Manga', 1999, 220, 239, NULL),
(413, 'One Piece', 'Eiichiro Oda', 'OnePiece.jpg', 'available', 'Graphic Novels & Comics', 'Manga', 1997, 978, 72, NULL),
(414, '1984', 'George Orwell', '1984.jpg', 'available', 'Fiction', 'Dystopian', 1949, 328, 21, NULL),
(415, 'Moby Dick', 'Herman Melville', 'MobyDick.jpg', 'available', 'Fiction', 'Adventure', 1851, 585, 5, NULL),
(416, 'Pride and Prejudice', 'Jane Austen', 'PrideAndPrejudice.jpg', 'available', 'Fiction', 'Romance', 1813, 432, 8, NULL),
...
(419, 'The Catcher in the Rye', 'J.D. Salinger', 'TheCatcherInTheRye.jpg', 'available', 'Fiction', 'Classic', 1951, 277, 230, NULL),
(420, 'To Kill a Mockingbird', 'Harper Lee', 'ToKillAMockingbird.jpg', 'available', 'Fiction', 'Classic', 1960, 281, 34, NULL),
...
(432, 'Chainsaw Man', 'Tatsuki Fujimoto', 'ChainsawMan.jpg', 'available', 'Graphic Novels & Comics', 'Action', 2018, 192, 12, NULL),
...
(445, 'Gone Girl', 'Gillian Flynn', 'GoneGirl.jpg', 'available', 'Fiction', 'Thriller', 2012, 432, 15, NULL),
...
(455, 'Demon Slayer', 'Koyoharu Gotouge', 'demonslayer.jpg', 'available', 'Graphic Novels & Comics', 'Manga', 2019, 4496, 62, 'A teen, a demon, a coward and a boar fighting Michael Jackson');
...
(413, 'Hakiro', '2025-04-15 17:54:12'),
(432, 'Hakiro', '2025-04-15 17:54:26'),
(455, 'Hakiro', '2025-04-15 18:14:21');
...
(455, 'Hakiro', 'Interesting read', '2025-04-15 18:14:36');
...
('HANSEL', 'RYAN', 'HMKR22', 'hanselmuluyaryan@gmail.com', 'Librarian');
...
('Hakiro', 'Ryan', 'Haki', 'hakiroryan@gmail.com', '$2y$10$a1s5Yo92NCdImvWdDw5yKuKnEi9GviuQJtjMMY9efpSd5T.zG0KUq', NULL, 0, NULL),
('Muluya', 'Hansel', 'Hakiro', '2023bcs080@std.must.ac.ug', '$2y$10$b.k1XYJtwyee/eCiRp.oL.xrR8krSgdJhNvHp0ptaWihOPuF9v12C', NULL, 0, NULL),
('HANSEL', 'RYAN', 'HMK', 'hanselmuluyaryan@gmail.com', '$2y$10$nACNL.279hAR8VvAl7eP5OCpeL7HOfHDfL3X2FK.DKQAO3FYJSocW', 'HMKR22', 1, NULL),
('Him', 'Ryan', 'Libman', 'abc@gmail.com', '$2y$10$nACNL.279hAR8VvAl7eP5OCpeL7HOfHDfL3X2FK.DKQAO3FYJSocW', NULL, 0, NULL);
...
--
ALTER TABLE `books`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=457;
