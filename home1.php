...
<body>
    <header>
        ...
        <div class="nav-tabs">
            <a href="/VL/home1.php" class="nav-tab active">E-Books</a>
            <a href="/VL/auxhome.php" class="nav-tab">Audiobooks</a>
        </div>
    </header>
    ...
    <!-- Audiobook Promotion Section -->
    <div class="audiobook-promo">
        <h3>Discover Audio Library</h3>
        <p>Enhance your reading experience with our collection of audiobooks. Listen to your favorite books narrated by professional voice actors.</p>
        <a href="/VL/auxhome.php" class="explore-btn">Explore Audiobooks</a>
    </div>
